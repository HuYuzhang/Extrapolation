...
NAIVE means that the network don't need the optical flow as input
DUAL means I will warp both the first and the second input
'''
...
class Network(torch.nn.Module):
    ...
    def forward(self, tensorInput1, tensorInput2):
        ...
        tensorDot2 = sepconv.FunctionSepconv()(self.modulePad(tensorWarp2), self.moduleVertical2(tensorCombine),
