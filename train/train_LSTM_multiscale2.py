...
For the downsample operation, I  use the convolution operation with a stride of 2 pixel, so more param need to be learned
...
def main(lr, batch_size, epoch, gpu, train_set, valid_set):
    ...
    for epoch in range(0,EPOCH):
        ...
        torch.save(SepConvNet.state_dict(),
                os.path.join('.', 'multiscale_v2_LSTM_iter' + str(epoch + 1)
                                + '-ltype_fSATD_fs'
