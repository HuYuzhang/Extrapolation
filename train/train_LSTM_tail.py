...
def main(lr, batch_size, epoch, gpu, train_set, valid_set):
    ...
    SepConvNet.load_my_state_dict(torch.load('ft2_baseline_iter86-ltype_fSATD_fs-lr_0.001-trainloss_0.1249-evalloss_0.1155-evalpsnr_29.9327.pkl'))
    ...
    for epoch in range(0,EPOCH):
        ...
        torch.save(SepConvNet.state_dict(),
                os.path.join('.', 'tail_LSTM_iter' + str(epoch + 1)
                                + '-ltype_fSATD_fs'
